...
<td><?php echo $reg['PERSONAS_AYN']?></td>
</tr>
<tr>
<td>Editar Monto de Mora:</td>
<td><input type="text" name="CLIENTES_IMPORTE_MORA" value="<?php echo $reg['CLIENTES_IMPORTE_MORA']?>"></td>
</tr>
<tr>
<td><input type="hidden" name="ID_CLIENTES" value="<?php echo $reg['ID_CLIENTES']?>"></td>
</tr>
<tr>
