...
<td><input type="text" name="PERSONAS_DNI" class="easyui-numberbox" required="true"></td>
</tr>
<tr>
...
<td><input type="text" name="PERSONAS_DOMICILIO" class="easyui-numberbox" required="true"></td>
</tr>
